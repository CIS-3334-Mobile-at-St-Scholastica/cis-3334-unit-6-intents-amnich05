...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupButtonClickEvents() {
        ...
        /**
         *   Set up button click event listener for the calendar button for the first performance
        ...
        but1Calendar.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                // check if there is an app to do calendar stuffs
                PackageManager packageManager = getPackageManager();
                List activities = packageManager.queryIntentActivities(calIntent,
                        PackageManager.MATCH_DEFAULT_ONLY);
                if (activities.size() > 0) {            // found at least one app to view calendar
        ...
        btn1Map.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                List activities = packageManager.queryIntentActivities(mapIntent,
                        PackageManager.MATCH_DEFAULT_ONLY);
                if (activities.size() > 0) {            // found at least one app to display maps
    ...
    private void setupButtonClickEvents2() {
        ...
        but1Calendar.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                GregorianCalendar begDate = new GregorianCalendar(2018, 3, 2, 19, 0);
                GregorianCalendar endDate = new GregorianCalendar(2018, 3, 2, 21, 0);
                calIntent.putExtra(CalendarContract.EXTRA_EVENT_BEGIN_TIME,
                        begDate.getTimeInMillis());
                calIntent.putExtra(CalendarContract.EXTRA_EVENT_END_TIME,
                        endDate.getTimeInMillis());
